...
import 'package:webfront/childPost.dart';
...
class childPostpage extends StatefulWidget {
  const childPostpage({Key? key}) : super(key: key);

  @override
  _childPostpageState createState() => _childPostpageState();
}

class _childPostpageState extends State<childPostpage> {
  File? myfile;
  File? myfile2;
  Emoji? selectedEmoji;
