...
class profileOtherChildpage extends StatefulWidget {
  final String name;
  final String email;
  final String profilePicture;

  const profileOtherChildpage({
    Key? key,
    required this.name,
    required this.email,
  ...
  @override
  _profileOtherChildpageState createState() => _profileOtherChildpageState();
}

class _profileOtherChildpageState extends State<profileOtherChildpage> {
  File? myfile;
  File? myfile2;
  Emoji? selectedEmoji;
